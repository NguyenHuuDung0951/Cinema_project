...
public class ProfileForm extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ngày bắt đầu làm:");
...
private javax.swing.ButtonGroup genderGroup;
    ...
    private void loadEmployee(Employee emp) {
        ...
        jDateChooser1.setDate(Date.valueOf(emp.getDateOfBirth()));
        jDateChooser1.setDateFormatString("dd-MM-yyyy");
        jDateChooser2.setDate(Date.valueOf(emp.getDateJoin()));
        ...
        jTextField2.setText(emp.getEmail());
        jTextField3.setText(emp.getPhoneNumber());
